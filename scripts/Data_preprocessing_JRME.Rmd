...
Con los datos escalados, hallamos el Cronbach Alpha

```{r}
RcmdrMisc::reliability(cov(data_cleaned_2[,c("ME_Q2_tr", 
                                             "ME_Q3_tr", 
                                             "ME_Q4_tr")], 
                           use ="complete.obs"))
```

El valor del cronbach alpha da mayor a 0.7
...
```{r}
cor(data_cleaned_2[,c("NET_Q1", "NET_Q2", "NET_Q3", "NET_Q4")], use = "complete")
```
...
```{r}
RcmdrMisc::reliability(cov(data_cleaned_3[,c("NET_Q1_tr", 
                                             "NET_Q2_tr", 
                                             "NET_Q3_tr", 
                                             "NET_Q4_tr")], 
                           use ="complete.obs"))
