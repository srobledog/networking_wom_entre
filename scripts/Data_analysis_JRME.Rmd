...
data_vivi_autscale_total_8_1 <- # ME_Q3_trans missing!!!!
  data_vivi_autscale_total_8 |> 
...
PLS_model_8 <- 
  plsm(data = as.data.frame(data_vivi_autscale_total_8_outliers), 
       strucmod = model_pls_8, 
       measuremod = model_sem_data_8)

```

```{r}
PLS_fit_8 <- 
  sempls(model = PLS_model_8, 
         data = as.data.frame(data_vivi_autscale_total_8_outliers))
```

```{r}
plsLoadings(PLS_fit_8) 
```
